                ...
                <div class="card-body">
                    ...
                    <!-- <fieldset disabled> -->
                        <div class="form-group">
                            ...
                            <input type="text" name="kode_barang" class="form-control" id="kode_barang" value="<?php echo $zoya['kode_barang']; ?>">
                    ...
                    <!-- </fieldset> -->
                        ...
                        <button type="submit" name="transaksi" class="btn btn-primary float-right">Tambah Data</button>
                    </form>
                </div>
            </div>
